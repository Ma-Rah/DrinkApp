function DrinkDetails(props) {
  ...
  return (
    <div className="w-full flex justify-center">
      <div className=" mx-auto container lg:w-1/2 xl:w-1/3 bg-indigo-50 ">
        <div
          className=" p-2 my-1 flex flex-col justify-around items-center
					text-center leading-loose w-full"
        >
          <h1 className="text-xl sm:text-2xl md:text-4xl text-red-500 py-2">
            {name}
          </h1>
          <img
            src={image && image}
            alt={name}
            className="shadow rounded w-32 h-32"
          />
